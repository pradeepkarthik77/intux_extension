...
if __name__ == '__main__':
    ...
    fixation_data = pd.read_csv('fixation.csv')  # Replace 'your_fixation_data.csv' with your actual CSV file path

    # Ensure that the CSV file has the columns 'x', 'y', and 'fixation'
    fix_arr = fixation_data[['normalizedX', 'normalizedY', 'normalizedTimestamp']].values
